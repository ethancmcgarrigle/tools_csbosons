...
# Kkeithley:9/10/19 - ported to Python 3
...
def doStats(warmupdata,Data,doGraphs=False,doWriteStdout=False,graphFilenameStub=''):
    ...
    if doGraphs:
        ...
        # kkeithley: normed=1 changed to density=1 to avoid warnings about
        # depriciation
        n,bins,patches=pl.hist(Data,25,density=1,facecolor="green",alpha=0.5)
        ...
        #pl.axhline(0,color='black')
        #
        # kkeithley: original savefig wasn't working because the stub contained
        # an unescaped /
        fig_save_name = graphFilenameStub.split("_")[-1]
        pl.savefig(fig_save_name + ".png")
