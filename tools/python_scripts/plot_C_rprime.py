...
if d == 2:
    ...
    plt.errorbar(list_x[0:stop_indx]/lam_T, corr_sorted[0][0:stop_indx].real/corr_sorted[0][0].real, normalized_errs[0][0:stop_indx], elinewidth=0.5, linewidth = 0.5,  color = 'r', marker = '*', label = '$C(r)$')
elif d == 1:
...
#plt.xlim(-1, 1)
plt.legend()
plt.savefig('low_T_2D_corr_fxn.eps')
plt.show()
